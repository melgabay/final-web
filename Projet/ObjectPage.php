...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" >
                    ...
                    <?php  echo ' <li class="nav-item"><a class="nav-link" href="list_page.php">'. $row["t_name"]. '</a></li>'; 	?> 
    ...
    <main class="main-form">
        ...
        <div class="change-button">
            ...
            <a href="changepage.php" class="edit"> <button type="button" class="btn btn-secondary">Edit</button></a>
        </div>
